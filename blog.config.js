...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个脱离了低级趣味的人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://gm.cloudns.ch', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '车前子', // 网站关键词 英文逗号隔开
